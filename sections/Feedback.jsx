  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Salmaan</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Founder of QUADVERTEX</p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[20px] text-[16px] sm:leading-[45px] leading-[39px] text-white">
          “At Quadvertex, we believe technology is the gateway to infinite possibilities—just like the universe itself. Our mission is to craft innovative, scalable, and secure solutions that empower businesses to reach new heights. With a passion for exploration and precision, we’re here to shape the future of digital transformation”
        </p>
      </motion.div>
